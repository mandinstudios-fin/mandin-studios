...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className='pCard sticky laptop:top-32 cursor-pointer'>
        <div className={`relative -z-1 bg-[${color}] text-[${text}] rounded-3xl h-[30vh] tablet:h-[33vh] laptop:w-[35vh] laptop:h-[40vh] hover:scale-105 transition duration-500 shadow-lg`}>
