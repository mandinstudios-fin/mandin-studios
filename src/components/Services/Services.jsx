...
const About = () => {
  ...
  return (
    <>
        <div className='z-10 mt-12 tablet:mt-32 text-center pb-16 overflow-y-clip'>
            ...
            <div ref={container}>
                <div className='sticky top-20 tablet:top-56 laptop:top-40'>
                    ...
                    <div className='inline laptop:inline-block'><h1 className='text-4xl md:text-6xl font-bold '>What We Do </h1></div>
                </div>
